<template>
  <section class="f-center full bg-red">
    <br />
    <br />
    <br />
    <br />
      ...
      <Col :xs="22" :lg="11">
        <Collapse v-model="value1">
          <Row type="flex" justify="center">
            <Col
              :xs="18"
              class="f-white bold m-auto"
            >¿Cómo lavarse las manos para evitar el COVID-19?</Col>
            <Col :xs="4">
              <a href class="font-25 f-white bold">+</a>
            </Col>
          </Row>
        </Collapse>
      </Col>
    ...
    <Row type="flex" justify="center">
      <Col :xs="22" :lg="11">
        <Collapse v-model="value2">
          <Row type="flex" justify="center">
            <Col :xs="18" class="f-white bold m-auto">¿Por qué no debes salir durante la cuarentena?</Col>
            <Col :xs="4">
              <a href class="font-25 f-white bold">+</a>
            </Col>
          </Row>
